...
<?php if($this->userDetails->virtuemart_user_id==0) {
	echo '<h3>'.vmText::_('COM_VIRTUEMART_YOUR_ACCOUNT_REG').'</h3>';
}?>
<form method="post" id="adminForm" name="userForm" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user',$this->useXHTML,$this->useSSL) ?>" class="form-validate account_form_validate">
