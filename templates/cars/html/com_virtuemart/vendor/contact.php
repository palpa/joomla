...
<div class="vendor-details-view">
	<h3><?php echo $this->vendor->vendor_store_name;
...
?>
		...
		<h5><?php echo vmText::_('COM_VIRTUEMART_VENDOR_ASK_QUESTION')  ?></h5>
		...
		<div class="form-field">
			...
			<form method="post" class="form-validate" action="<?php echo JRoute::_('index.php') ; ?>" name="askform" id="askform">
				...
				<label><?php //echo vmText::_('COM_VIRTUEMART_USER_FORM_NAME')  ?>
					<input type="text" class="validate[required,minSize[4],maxSize[64]]" value="<?php echo $this->user->name ?>" Placeholder="Name" name="name" id="name" size="29"  validation="required name"/>
				</label>
				<br />
				<label><?php //echo vmText::_('COM_VIRTUEMART_USER_FORM_EMAIL')  ?>
					<input type="text" class="validate[required,custom[email]]" value="<?php echo $this->user->email ?>" Placeholder="Email" name="email" id="email" size="29"  validation="required email"/>
				</label>
				<br/>
				<label>
					<?php
					...
					?>
					<br />
					<textarea title="<?php echo $ask_comment ?>" class="validate[required,minSize[<?php echo $min ?>],maxSize[<?php echo $max ?>]] field" id="comment" name="comment" cols="30" rows="10" Placeholder="Please write your question....(min. 50, max. 2000 characters)	
"></textarea>
				</label>
				<div class="submit">
