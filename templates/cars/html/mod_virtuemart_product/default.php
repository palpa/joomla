		...
		<div class="vmproduct<?php echo $params->get ('moduleclass_sfx'); ?> productdetails">
			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?>">
				<div class="spacer">
					...
					echo "<div class='product_name_img'>" . JHTML::_ ('link', JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' . $product->virtuemart_category_id), $image, array('title' => $product->product_name)) . "</div>";
